<?php 
    ...
    if (isset($_REQUEST['fixed30'])) {
        ...
        echo "<br> - BBT <br>";
        $myQuery = new QueryDB();
        $myQuery->getRate(1,1,$_REQUEST['lockDays'],$_REQUEST['zipCode'], $_REQUEST['loanAmount'],1.00);
       echo "<br> - BOKF <br>";
        $myQuery = new QueryDB();
        $myQuery->getRate(2,1,$_REQUEST['lockDays'],$_REQUEST['zipCode'], $_REQUEST['loanAmount'],1.00);
    }; 
    if (isset($_REQUEST['fixed15'])) {echo "15 years Fixed <br>" ; }; 
    if (isset($_REQUEST['fixed10'])) {echo "10 years Fixed <br>" ; }; 
